...
-(void)loadView
{
    ...
    UIBarButtonItem *anotherButton = [[UIBarButtonItem alloc] initWithTitle:@"清空" style:UIBarButtonItemStylePlain target:self action:@selector(onClearBtn:)];
...
{
    [self understandHandler];
}

/*
 * @ 语义理解
 */
-(void) understandHandler
{
